...
export default class PointerDragging {
  ...
  // Returns a boolean whether this was mouse click and no ctrl key (which means right click on Mac)
  isMouseButton(ev: MouseEvent) {
    return ev.button === this.buttonCode && !ev.ctrlKey
  }
